...
/* =============================
  ...
  $(".tablasServicios tbody").on("click", "button.agregarProducto", function(){
...
$(".tablasServicios").on("draw.dt", function(){
...
numProducto++;
var datos = new FormData();
datos.append("traerProductos", "false");
...
/* ===========================================================
  	...
  	$(".formularioServicio").on("change", "select.nuevaDescripcionProducto", function(){
...
$("#nuevoMetodoPago").change(function(){
 ...
 /*=============================================
	CAMBIO EN EFECTIVO
   =============================================*/
$(".formularioServicio").on("change", "input#nuevoValorEfectivo", function(){
 ...
 /*=============================================
	CAMBIO Transaccion
   =============================================*/
$(".formularioServicio").on("change", "input#nuevoCodigoTransaccion", function(){
