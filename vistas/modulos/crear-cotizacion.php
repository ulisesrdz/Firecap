    ...
    <div class="row">
      ...
      <div class="col-lg-5 col-xs-12">
              ...
              <div class="box">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    if(!$ventas){
                      ...
                      echo '<input type="text" class="form-control" id="nuevaCotizacion" name="nuevaCotizacion" value="10001" readonly>';
                ...
                <div class="form-group">
                     ...
                     <div class="input-group">
                      ...
                      <span class="input-group-addon"><i class="fa fa-user"></i></span> 
                     <textarea id="nuevaObservacion" class="form-control" name="nuevaObservacion" placeholder="Ingresar Observaciones" cols="60" rows="3" style="resize:none"></textarea>
                    </div>
        ...
        <?php
          ...
          $guardarCotizacion = new ControladorVentas();
